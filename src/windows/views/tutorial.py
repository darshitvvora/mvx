...
class TutorialDialog(QWidget):
    ...
    def __init__(self, id, text, arrow, *args):
        ...
        if self.id == "0":
            ...
            checkbox_metrics.setText(_("Yes, I would like to improve Edit X Pro!"))
...
class TutorialManager(object):
    ...
    def __init__(self, win):
        ...
        self.tutorial_objects = [    {"id":"0", "x":400, "y":0, "object_id":"filesTreeView", "text":_("<b>Welcome!</b> Edit X Pro is an award-winning, open-source video editing application! This tutorial will walk you through the basics.<br><br>Would you like to automatically send errors and metrics to help improve Edit X Pro?"), "arrow":False},
                                     ...
                                     {"id":"2", "x":200, "y":-15, "object_id":"timeline", "text":_("<b>Sequencer:</b> Arrange your clips on the timeline here. Overlap clips to create automatic transitions. Access lots of fun presets and options by right-clicking on clips."), "arrow":True},
