...
class TutorialManager(object):
    ...
    def __init__(self, win):
        ...
        self.tutorial_objects = [    {"id":"0", "x":400, "y":0, "object_id":"filesTreeView", "text":_("<b>Welcome!</b> Edit X Pro is amazing wedding video editing application! This tutorial will walk you through the basics.<br><br>Would you like to automatically send errors and metrics to help improve Edit X Pro?"), "arrow":False},
