...
COPYRIGHT = "Copyright (c) 2018-2019 %s" % COMPANY_NAME
CWD = os.getcwd()
PATH = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))  # Primary openshot folder
HOME_PATH = os.path.join(os.path.expanduser("~"))
USER_PATH = os.path.join(HOME_PATH, ".editxpro_qt")
BACKUP_PATH = os.path.join(USER_PATH)
BLENDER_PATH = os.path.join(USER_PATH, "C:\\Program Files (x86)\\Blender Foundation\\Blender\\blender.exe")
...
JT = {"name": u"Unknown", "email": "hello@editxpro.com", "website":"http://editxpro.com"}
