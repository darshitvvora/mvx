...
class project():
    ...
    def __init__(self, init_threads=True):
        ...
        self.UI_DIR = os.path.join(self.BASE_DIR, "editxpro", "windows", "ui")
        self.IMAGE_DIR = os.path.join(self.BASE_DIR, "editxpro", "images")
        self.LOCALE_DIR = os.path.join(self.BASE_DIR, "editxpro", "locale")
        self.PROFILES_DIR = os.path.join(self.BASE_DIR, "editxpro", "profiles")
        self.TRANSITIONS_DIR = os.path.join(self.BASE_DIR, "editxpro", "transitions")
        self.BLENDER_DIR = os.path.join(self.BASE_DIR, "editxpro", "blender")
        self.EXPORT_PRESETS_DIR = os.path.join(self.BASE_DIR, "editxpro", "export_presets")
        self.EFFECTS_DIR = os.path.join(self.BASE_DIR, "editxpro", "effects")
        # location for per-session, per-user, files to be written/read to
        self.DESKTOP = os.path.join(os.path.expanduser("~"), "Desktop")
        self.USER_DIR = os.path.join(os.path.expanduser("~"), ".editxpro")
        self.THEMES_DIR = os.path.join(self.BASE_DIR, "editxpro", "themes")
